...
from KanhaMusic.utils.inline import botplaylist_markup
...
def PlayWrapper(command):
    async def wrapper(client, message):
        ...
        # ── userbot join logic (AnonX-style: handles banned/restricted too) ──
        if not await is_active_chat(chat_id):
            ...
            try:
                ...
                # AnonX addition: try to unban if UB is banned/restricted
