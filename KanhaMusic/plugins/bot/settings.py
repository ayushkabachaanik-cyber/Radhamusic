...
from KanhaMusic.utils.decorators.admins import ActualAdminCB
from KanhaMusic.utils.decorators.language import language, languageCB
from KanhaMusic.utils.inline.settings import (
    auth_users_markup,
    playmode_users_markup,
    setting_markup,
    vote_mode_markup,
)
from KanhaMusic.utils.inline.start import private_panel
...
@app.on_callback_query(filters.regex("shiv_Anu") & ~BANNED_USERS)
@languageCB
